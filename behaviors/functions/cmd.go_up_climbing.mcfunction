##north
execute as @e[tag=climber, c=1, ry=45, rym=-45] unless block ~ ~ ~+1 air unless block ~ ~ ~+1 glass unless block ~ ~ ~+1 stained_glass unless block ~ ~ ~+1 glass_pane unless block ~ ~ ~+1 stained_glass_pane unless block ~ ~ ~+1 leaves unless block ~ ~ ~+1 leaves2 unless block ~ ~ ~+1 azalea_leaves unless block ~ ~ ~+1 azalea_leaves_flowered unless block ~ ~ ~+1 mangrove_leaves run effect @s levitation 1 5 false
